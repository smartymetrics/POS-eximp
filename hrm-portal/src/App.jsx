            ...
            {filtered.map(e => {
              ...
              return (<tr key={e.id}>
                ...
                <td><div style={{ display: "flex", gap: 6 }}>
                  ...
                  {e.status === "Approved" && <button className="bp" style={{ fontSize: 10, padding: "4px 10px", background: "#10B981", opacity: payingId === e.id ? 0.6 : 1 }} disabled={payingId === e.id} onClick={() => markPaid(e)}>💳 Mark Paid</button>}
                  {e.status === "Paid" && <span style={{ fontSize: 10, color: "#10B981", fontWeight: 800 }}>✓ Reimbursed</span>}
