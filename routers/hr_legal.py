  ...
  <table style="width: 100%; border-collapse: collapse;">
    <tr>
      <td style="width: 50%; padding-right: 40px; vertical-align: top;">
        ...
        {"<img src='" + sig_image + "' style='max-width: 260px; max-height: 110px; border: 1px solid #eee; padding: 6px; display: block; margin-bottom: 6px; background: #fff;'>" if sig_image else "<div style='height: 60px; border-bottom: 1px solid #333; margin-bottom: 6px;'></div>"}
