...
from email_service import send_welcome_email, send_admin_alert_email
...
async def form_submission(
    ...
    try:
        ...
        background_tasks.add_task(send_welcome_email, full_client, invoice.get("property_name", "our property"))
